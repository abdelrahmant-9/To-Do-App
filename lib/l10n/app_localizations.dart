...
abstract class AppLocalizations {
  ...
  /// No description provided for @passwordTooShort8.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @passwordNoSpecialChar.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @nameTooShort3.
  ///
  /// In en, this message translates to:
  /// **'Name must be at least 3 characters'**
  String get nameTooShort3;

  /// No description provided for @nameOnlyNumbers.
  ///
  /// In en, this message translates to:
  /// **'Name cannot contain numbers only'**
  String get nameOnlyNumbers;
}
